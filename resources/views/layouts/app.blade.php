        ...
        <div class="mx-auto w-full max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
            <div class="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
                <div class="space-y-4">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <a href="https://www.tiktok.com/@tu4nki3t?lang=vi-VN" class="flex h-9 w-9 items-center justify-center rounded-full border border-lux-gold/30 bg-lux-card text-lux-gold shadow-sm transition hover:-translate-y-0.5 hover:bg-lux-gold/10" aria-label="TikTok">
                            <svg viewBox="0 0 24 24" class="h-4 w-4" fill="currentColor" aria-hidden="true">
                ...
                <div class="space-y-4">
                    <div class="rounded-2xl border border-white/10 bg-lux-card p-4 text-sm text-lux-text/70 shadow-sm">
                        ...
                        <p class="mt-1">Thanh toán mã hóa TLS 1.3 • Tiêu chuẩn bảo mật PCI-DSS • Giám sát rủi ro 24/7</p>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-10 flex flex-col gap-6 border-t border-white/10 pt-6 text-sm text-lux-text/70 md:flex-row md:items-center md:justify-between">
                <div class="flex flex-wrap items-center gap-3">
                    <span class="text-xs font-semibold uppercase tracking-wide text-lux-text/60">Phương thức thanh toán</span>
                    <span class="rounded-full border border-lux-gold/30 bg-lux-card px-3 py-1 text-xs font-semibold text-lux-gold">Visa</span>
                    <span class="rounded-full border border-lux-gold/30 bg-lux-card px-3 py-1 text-xs font-semibold text-lux-gold">Mastercard</span>
                    <span class="rounded-full border border-lux-gold/30 bg-lux-card px-3 py-1 text-xs font-semibold text-lux-gold">MoMo</span>
                </div>
